package com.androidmads.navdraweractivity.Module;
...
import com.androidmads.navdraweractivity.Other.BaseActivity;
import com.androidmads.navdraweractivity.R;
import com.androidmads.navdraweractivity.Other.TimerActivity;
...
public class WorkoutModuleCreateActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //navigationView.setCheckedItem(R.id.nav_activity_create_workout);
    ...
    public void setupButtons() {
        text1 = (TextView) findViewById(R.id.textView_hang);
        button = (Button) findViewById(R.id.button_hangtime);
        ...
        button_hangtime = (Button) findViewById(R.id.button_hangtime);
        button_hangtime.setText(HangTime_min+" min "+HangTime_sec+" sec");
        text_resttime = (TextView) findViewById(R.id.textView_rest);
        button_resttime = (Button) findViewById(R.id.button_resttime);
        if (Repetitions == 1) {
        ...
        button_repetitions = (Button) findViewById(R.id.button_repetitions);
        button_repetitions.setText(Repetitions+" Times");
        button_sets = (Button) findViewById(R.id.button_sets);
        button_sets.setText(Sets+" Times");
        text_breaktime = (TextView) findViewById(R.id.textView_breaks);
        button_breaks = (Button) findViewById(R.id.button_breaks);
        if (Sets == 1) {
        ...
        button_name = (Button) findViewById(R.id.select_name);
...
/*
    ...
    public void selectName(View view) {
        ...
        final Button b1 = (Button) d.findViewById(R.id.dialogN_button1);
        Button b2 = (Button) d.findViewById(R.id.dialogN_button2);
        final EditText ed = (EditText) d.findViewById(R.id.dialog_selectName);
    ...
    public void selectRepetitions(View view) {
        ...
        Button b2 = (Button) d.findViewById(R.id.dialogN_button2);
        final NumberPicker np = (NumberPicker) d.findViewById(R.id.dialog_selectName);
